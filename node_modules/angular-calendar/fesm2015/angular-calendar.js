...
class CalendarAngularDateFormatter {
    ...
    weekViewTitle({ date, locale, weekStartsOn, excludeDays, daysInWeek }) {
        ...
        /** @type {?} */
        const format = (dateToFormat, showYear) => new DatePipe(locale).transform(dateToFormat, 'MMM d' + (showYear ? ', yyyy' : ''), null, locale);
